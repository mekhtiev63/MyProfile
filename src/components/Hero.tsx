...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 pb-12 pt-8 md:min-h-[calc(100svh-3.5rem)] md:px-10 md:py-20">
        ...
        {/* На md+ вне потока — не толкает highlights; на mobile под текстом */}
        <div className="weaver-slot">
          <ThreadWeaver />
        </div>
      </div>
    </section>
